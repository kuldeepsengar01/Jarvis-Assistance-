    ...
    <style>
        ...
        * {
        ...
        .shell {
            ...
            border: 1px solid rgba(91, 211, 255, 0.15);
            border-radius: 28px;

            box-shadow:
                0 30px 90px rgba(0, 0, 0, 0.55),
                0 0 100px rgba(40, 210, 255, 0.06);
        }
        ...
        .online {
            ...
            color: #68efa9;
            background: rgba(66, 255, 170, 0.07);
        ...
        .orb {
            ...
            box-shadow:
                ...
                0 0 100px rgba(56, 217, 255, 0.10);
        ...
        .orb::before {
            ...
            border: 1px solid rgba(90, 225, 255, 0.34);
            border-right-color: rgba(90, 225, 255, 0.72);
        ...
        .orb::after {
            ...
            border: 1px solid rgba(90, 225, 255, 0.08);
            border-left-color: rgba(90, 225, 255, 0.50);
        ...
        .quick button {
            ...
            border: 1px solid rgba(85, 215, 255, 0.11);
            border-radius: 999px;

            color: #c9efff;

            background: rgba(14, 29, 53, 0.80);
        ...
        .input-wrap {
            ...
            border: 1px solid rgba(82, 213, 255, 0.14);
            border-radius: 18px;
